    ...
    return (
        <main>
            <div className="flex flex-col text-center">
                <div className="m-2 w-10/12 mx-auto md:w-3/4 md:my-4">
                    <h2 className="underline text-2xl">Summary</h2>
                ...
                <div className="lg:flex lg:flex-row lg:justify-evenly lg:bg-cyan-50">
                    ...
                    <div className="m-2 md:m-4 lg:flex-1">
                        <h2 className="underline text-2xl">Education</h2>
                        <h3 className="font-bold w-10/12 mx-auto">The University of Texas At Austin, Austin, TX - Certification</h3>
                ...
                <div className="m-2 md:m-4">
                    ...
                    <h3 className="font-bold w-10/12 mx-auto">River City Smoked Meats, New Braunfels, TX - Kitchen Manager</h3>
                ...
                <Link className="bg-RoseyBrown w-40 rounded-md text-white p-1 mx-auto" to='/Zachary Davis Resume.pdf' target='_blank' download>Download Resume</Link>
            </div>
        </main>
    )
}
