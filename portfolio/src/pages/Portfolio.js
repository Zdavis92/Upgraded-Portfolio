        ...
        <main className="flex flex-col items-center text-center w-11/12 mx-auto">
            ...
            <div className="flex flex-col lg:flex-row">
                <div className="md:flex-1">
                    ...
                    <a href="https://we-help-austin.herokuapp.com/" target='_blank'><img className="rounded-2xl shadow-xl aspect-video w-11/12 mx-auto" src={weHelpImg}></img></a>
                ...
                <div className="mt-4 lg:mt-0 md:flex-1">
                    ...
                    <a href="https://connected-jobsearch-engine.herokuapp.com/" target="_blank"><img className="rounded-2xl shadow-xl w-11/12 aspect-video mx-auto" src={connectedImg}></img></a>
