...
const Header = () => {
    return (
        <header className="flex flex-row md:flex-wrap justify-between content-center mb-4 border-b-2 rounded-md shadow-lg" >
            <div className='flex flex-col basis-3/4 m-1 text-sky-800 font-serif font-medium md:w-5/12 md:basis-auto justify-center lg:ml-10'>
