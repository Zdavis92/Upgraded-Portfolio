    ...
    return (
        <main>
            <div className="flex flex-col text-center">
                ...
                <Link className="bg-RoseyBrown w-40 rounded-md shadow-lg text-white p-1 mx-auto lg:my-4" to='/Zachary Davis Resume.pdf' target='_blank' download>Download Resume</Link>
            </div>
        </main>
    )
}
